...
public class Constants {
    ...
    public static final float TIMETABLE_CELL_DP = 50;
    public static final float TIMETABLE_CELL_SUBJECT_DP = 10;
    public static final float TIMETABLE_CELL_TEACHER_DP = 3;
    public static final float TIMETABLE_CELL_GROUP_DP = 3;
}
