...
public class Constants {
    ...
    public static final float TIMETABLE_CELL_DP = 100;
    public static final float TIMETABLE_CELL_PADDING_DP = 5;
    public static final float TIMETABLE_CELL_SUBJECT_DP = 10;
    public static final float TIMETABLE_CELL_TEACHER_DP = 8;
    public static final float TIMETABLE_CELL_GROUP_DP = 8;
}
